...
-- 2024-02-20,SidneyHutchison,Completed File
--**************************************************************************--
Begin Try
	Use Master;
	If Exists(Select Name From SysDatabases Where Name = 'Assignment06DB_SidneyHutchison')
	 Begin 
	  Alter Database [Assignment06DB_SidneyHutchison] set Single_user With Rollback Immediate;
	  Drop Database Assignment06DB_SidneyHutchison;
	 End
	Create Database Assignment06DB_SidneyHutchison;
End Try
Begin Catch
	Print Error_Number();
End Catch
go
Use Assignment06DB_SidneyHutchison;
